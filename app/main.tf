provider "aws" {
  region                   = "us-east-1"
  shared_credentials_files = ["D:/2023/EAZYTREANING/BOOTCAMP-DevOps/Terraform-entrainement/aws_credentials"]
}


# Appelation du sg crée dans le module /Création du sg
module "sg" {
  source = "../modules/sg"
}

# Appelation du EBS cree dans le module Création du volume
module "ebs" {
  source    = "../modules/ebs"
  disk_size = 5
}
